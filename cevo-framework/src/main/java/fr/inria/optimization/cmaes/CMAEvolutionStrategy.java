...
is implemented in class <code>{@link fr.inria.optcmaes.examples.CMAExample2}</code>.</P>
...
public class CMAEvolutionStrategy implements java.io.Serializable {
	...
	private double veryInitialSigma;
...
//    }
    ...
    */
	 ...
	 * function values, see {@link #updateDistribution(double[][], double[])}}.
...
//        }
        ...
        /* update of sigma */
		if (this.options.constantSigma) {
			sigma = veryInitialSigma;
		} else {
			// Hansen's default
...
/** search space dimensions must be set before the optimization is started. */
    ...
    public void setInitialStandardDeviation(double startsigma) {
		...
		this.veryInitialSigma = startsigma;
    }
