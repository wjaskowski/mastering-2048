...
public enum TileType {
	 ...
	 * Piece TypeS.
	 */
	TypeS(new Color(BoardPanel.COLOR_MAX, BoardPanel.COLOR_MAX, BoardPanel.COLOR_MIN), 3, 3, 2, new boolean[][] {
		{
			false,	true,	true,
			true,	true,	false,
			false,	false,	false,
	 ...
	 */
	private TileType(Color color, int dimension, int cols, int rows, boolean[][] tiles, Tetromino tetromino) {
