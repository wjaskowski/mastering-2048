 ...
 */
public class JaskowskiSzubert2015CoCMAES4_2x2Player implements Factory<OthelloPlayer> {
	@Override
	...
	static {
		try {
			PLAYER = IOUtils.toString(JaskowskiSzubert2015CoCMAES4_2x2Player.class.getResourceAsStream("JaskowskiSzubert2015CoCMAES-4+2x2.player"));
		} catch (IOException e) {
