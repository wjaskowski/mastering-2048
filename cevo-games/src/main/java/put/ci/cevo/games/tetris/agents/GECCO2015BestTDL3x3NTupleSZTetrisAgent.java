...
/**
 * The best SZ-Tetris agent with 3x3 n-tuple evaluation function learned by TD(0) submitted to GECCO 2015
 */
public class GECCO2015BestTDL3x3NTupleSZTetrisAgent implements Factory<Agent<TetrisState, TetrisAction>> {
	...
	static {
		try {
			NTUPLES = SerializationManagerFactory.create().deserialize(
					GECCO2015BestTDL3x3NTupleSZTetrisAgent.class.getResourceAsStream(
							"gecco2015_3x3_tdl_sztetris_agent.serialized"));
