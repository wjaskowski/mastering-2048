 ...
 */
public class JaskowskiSzubert2015CoCMAES3Player implements Factory<OthelloPlayer> {
	@Override
	...
	static {
		try {
			PLAYER = IOUtils.toString(JaskowskiSzubert2015CoCMAES3Player.class.getResourceAsStream("JaskowskiSzubert2015CoCMAES-3.player"));
		} catch (IOException e) {
