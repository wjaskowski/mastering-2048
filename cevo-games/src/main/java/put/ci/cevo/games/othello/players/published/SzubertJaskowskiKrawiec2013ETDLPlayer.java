 ...
 * volume 5, 2013.
 */
public class SzubertJaskowskiKrawiec2013ETDLPlayer implements Factory<OthelloPlayer> {
	@Override
	...
	static {
		try {
			PLAYER = IOUtils.toString(SzubertJaskowskiKrawiec2013ETDLPlayer.class.getResourceAsStream(
					"SzubertJaskowskiKrawiec2013ETDL.player"));
		} catch (IOException e) {
