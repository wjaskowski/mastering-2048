...
public class SidePanel extends JPanel {
	 ...
	 * The small font.
	 */
	private static final Font SMALL_FONT = new Font("Times", Font.BOLD, 11);
	
	/**
	 * The large font.
	 */
	private static final Font LARGE_FONT = new Font("Times", Font.BOLD, 13);
	 ...
	 */
	public SidePanel(TetrisGUI tetris) {
		this.tetris = tetris;
	...
	public void paintComponent(Graphics g) {
		...
		g.drawString("Score: " + tetris.getScore(), SMALL_INSET, offset = STATS_INSET);
