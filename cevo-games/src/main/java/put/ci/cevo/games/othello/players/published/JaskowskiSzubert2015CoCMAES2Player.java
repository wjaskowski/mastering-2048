 ...
 */
public class JaskowskiSzubert2015CoCMAES2Player implements Factory<OthelloPlayer> {
	@Override
	...
	static {
		try {
			PLAYER = IOUtils.toString(JaskowskiSzubert2015CoCMAES2Player.class.getResourceAsStream("JaskowskiSzubert2015CoCMAES-2.player"));
		} catch (IOException e) {
