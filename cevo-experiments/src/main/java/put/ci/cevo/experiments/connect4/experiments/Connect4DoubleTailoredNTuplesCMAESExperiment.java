...
/**
 * Evaluates CMA-ES learning {@link put.ci.cevo.games.encodings.ntuple.DoubleNTuples} on the {@link put.ci.cevo.games.connect4.Connect4} game.
 *
 ...
 */
public class Connect4DoubleTailoredNTuplesCMAESExperiment implements Experiment, EvolutionStateListener, LastGenerationListener {

	private static final Logger logger = Logger.getLogger(Connect4DoubleTailoredNTuplesCMAESExperiment.class);
...
//	private final PerformanceMeasure<Connect4Player> objectiveMeasure = new LegacyConnect4PerfectPlayerPerformanceMeasure();
	...
	public void run(String[] args) {
		...
		IndividualFactory<DoubleNTuples> factory = new DoubleNTuplesFactory(
				new Connect4NTuplesSystematicFactory(-0.1, 0.1,
						"1111|1000; 1111|0010; " +
						"1|11|001|0001; 1|01|011|0001; 1|01|001|0011; 1|01|001|0001|0001 " +
						"1|1|1|1;"));
	...
	public static void main(String[] args) {
		new Connect4DoubleTailoredNTuplesCMAESExperiment().run(args);
	}
